...
.value('taOptions',  {
    ...
    classes: {
        focussed: "focussed",
        toolbar: "btn-toolbar",
        toolbarGroup: "btn-group-toolbar",
...
.factory('taToolFunctions', ['$window','taTranslations', function($window, taTranslations) {
    return {
        imgOnSelectAction: function(event, $element, editorScope){
            ...
            container.empty();
            var buttonGroup = angular.element('<div class="btn-group-toolbar" style="padding-right: 6px;">');
            ...
            buttonGroup = angular.element('<div class="btn-group-toolbar" style="padding-right: 6px;">');
            ...
            buttonGroup = angular.element('<div class="btn-group-toolbar">');
        ...
        aOnSelectAction: function(event, $element, editorScope){
            ...
            var buttonGroup = angular.element('<div class="btn-group-toolbar pull-right">');
